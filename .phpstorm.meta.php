...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\Repositories\Authentication\AuthContextRepositoryInterface' => \App\Repositories\Authentication\AuthContextRepository::class,
            'App\Contracts\Repositories\Authentication\AuthRepositoryInterface' => \App\Repositories\Authentication\AuthRepository::class,
            'App\Contracts\Repositories\Authentication\ResetPasswordRepositoryInterface' => \App\Repositories\Authentication\ResetPasswordRepository::class,
            'App\Contracts\Repositories\ProfileRepositoryInterface' => \App\Repositories\ProfileRepository::class,
            'App\Contracts\Repositories\SportRepositoryInterface' => \App\Repositories\SportRepository::class,
            'App\Contracts\Repositories\UserRepositoryInterface' => \App\Repositories\UserRepository::class,
            'App\Contracts\Repositories\VenueRepositoryInterface' => \App\Repositories\VenueRepository::class,
            'App\Contracts\Services\Authentication\AuthContextServiceInterface' => \App\Services\Authentication\AuthContextService::class,
            'App\Contracts\Services\Authentication\AuthenticationServiceInterface' => \App\Services\Authentication\AuthenticationService::class,
            'App\Contracts\Services\Authentication\EmailVerifyServiceInterface' => \App\Services\Authentication\EmailVerifyService::class,
            'App\Contracts\Services\Authentication\RegisterServiceInterface' => \App\Services\Authentication\RegisterService::class,
            'App\Contracts\Services\Authentication\ResetPasswordServiceInterface' => \App\Services\Authentication\ResetPasswordService::class,
            'App\Contracts\Services\HashServiceInterface' => \App\Services\HashService::class,
            'App\Contracts\Services\ProfileServiceInterface' => \App\Services\ProfileService::class,
            'App\Contracts\Services\ResponseServiceInterface' => \App\Services\ResponseService::class,
            'App\Contracts\Services\SportServiceInterface' => \App\Services\SportService::class,
            'App\Contracts\Services\StorageServiceInterface' => \App\Services\StorageService::class,
            'App\Contracts\Services\UserServiceInterface' => \App\Services\UserService::class,
            'App\Contracts\Services\VenueServiceInterface' => \App\Services\VenueService::class,
            'Illuminate\Auth\Passwords\TokenRepositoryInterface' => \Illuminate\Auth\Passwords\DatabaseTokenRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\felip\Documents\Projects\social-sports-api\public\storage' => 'string',
...
'images.default','view.paths','view.compiled','app.name','app.env',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\felip\\Documents\\Projects\\social-sports-api\\public\\storage',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','octane.server',
...
'octane.max_execution_time','octane.state_file','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'authentication.email.notify','authentication.email.verify','authentication.reset-password','authentication.forgot-password','authentication.login',
'authentication.register','user.me','sports.index',
'profiles.update','venues.index','venues.show','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'email-confirmed','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'validation.gt.numeric','validation.gt.file','validation.gt.string','validation.gt.array','validation.gte.numeric',
'validation.gte.file','validation.gte.string','validation.gte.array','validation.image','validation.in',
'validation.in_array','validation.integer','validation.ip','validation.ipv4','validation.ipv6',
'validation.json','validation.lt.numeric','validation.lt.file','validation.lt.string','validation.lt.array',
'validation.lte.numeric','validation.lte.file','validation.lte.string','validation.lte.array','validation.max.numeric',
'validation.max.file','validation.max.string','validation.max.array','validation.mimes','validation.mimetypes',
'validation.min.numeric','validation.min.file','validation.min.string','validation.min.array','validation.not_in',
'validation.not_regex','validation.numeric','validation.present','validation.regex','validation.required',
...
'validation.uploaded','validation.url','validation.uuid','validation.more','validation.enum',
'validation.custom.start_date.after_or_equal','validation.attributes.yesterday','validation.attributes.tomorrow','validation.attributes.today','validation.attributes.start_date',
'validation.attributes.end_date','validation.attributes.now','validation.attributes.address','validation.attributes.age','validation.attributes.body',
...
'validation.attributes.first_name','validation.attributes.gender','validation.attributes.hour','validation.attributes.last_name','validation.attributes.message',
'validation.attributes.minute','validation.attributes.mobile','validation.attributes.month','validation.attributes.name','validation.attributes.password',
'validation.attributes.phone','validation.attributes.second','validation.attributes.sex','validation.attributes.state','validation.attributes.subject',
'validation.attributes.text','validation.attributes.time','validation.attributes.title','validation.attributes.year','validation.attributes.number',
'validation.attributes.street','validation.attributes.default','validation.attributes.reference','validation.attributes.zipcode','validation.attributes.alias',
'validation.attributes.complement','validation.attributes.neighborhood','validation.attributes.description','validation.attributes.password_confirmation','validation.attributes.cpf',
'validation.attributes.quantity','validation.attributes.per_page','validation.attributes.sort_by','validation.attributes.sort_order','validation.attributes.filter_by',
'validation.attributes.is_active','validation.attributes.active','validation.attributes.limit','validation.attributes.search','validation.attributes.type',
'validation.attributes.label','validation.attributes.scope','validation.attributes.validation_rules','validation.attributes.created_at','validation.attributes.updated_at',
'validation.attributes.min_date','validation.attributes.max_date','validation.attributes.min_value','validation.attributes.max_value','validation.attributes.due_date',
'validation.attributes.file_type','validation.attributes.file','validation.attributes.radius_km','validation.attributes.sport_id','validation.password.mixed',
'validation.password.numbers','validation.password.symbols','validation.password.uncompromised',);
