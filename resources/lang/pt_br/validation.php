...
return [
    ...
    */
    ...
    'more' => '{1}(e mais :count erro)|[2,*](e mais :count erros)',
    ...
    */
    ...
    'custom' => [
        'start_date' => [
            'after_or_equal' => 'O campo data de inicio deve ser uma data posterior ou igual a data de hoje.',
        ],
    ],
    ...
    */
    ...
    'password' => [
        'mixed' => 'O campo senha deve conter ao menos um caracter maiúsculo e minúsculo.',
        'numbers' => 'O campo senha deve conter ao menos um número.',
        'symbols' => 'O campo senha deve conter ao menos um símbolo.',
